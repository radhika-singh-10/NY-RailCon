...
- Decentralisation, Horizontal Scalable - It is done using CockroachDB with PostgreSQL in Python, as all the queries of the project of PostgreSQL 4.0 are compatible with CockroachDB. 
